...
|------|----------|------|------|
| **fs/** | 9,328 | 22.5% | 文件系统 |
| **drivers/** | 7,337 | 17.7% | 设备驱动 |
| **arch/** | 6,572 | 15.9% | 架构相关 (RISC-V) |
| **tests/** | 5,741 | 13.9% | 单元测试 |
| **net/** | 4,675 | 11.3% | 网络协议栈 |
| **process/** | 2,133 | 5.2% | 进程管理 |
| **sched/** | 1,413 | 3.4% | 进程调度 |
| **mm/** | 1,238 | 3.0% | 内存管理 |
| **sync/** | 699 | 1.7% | 同步原语 |
| **其他** | ~3,137 | 7.6% | 主入口、配置等 |
