...
[![Code](https://img.shields.io/badge/code-86%2C800%20lines-blue.svg)](docs/architecture/structure.md)
...
|--------|-------|---------|
| **Lines of Code** | ~86,800 lines | [Code Structure](docs/architecture/structure.md) |
| **Source Files** | 255 files (251 Rust + 3 ASM + 1 LD) | [Project Structure](docs/architecture/structure.md) |
...
**Module Distribution**:
- Filesystem (fs/): 21,570 lines (24.8%)
- Unit Tests (tests/): 9,350 lines (10.8%)
- Device Drivers (drivers/): 8,893 lines (10.2%)
- Memory Management (mm/): 7,635 lines (8.8%)
- Architecture (arch/): 7,433 lines (8.6%)
- System Calls (syscall/): 7,162 lines (8.2%)
- Top-level: 5,983 lines (6.9%)
- Network Stack (net/): 5,215 lines (6.0%)
- Process Management (process/): 3,870 lines (4.5%)
- Process Scheduling (sched/): 3,467 lines (4.0%)
- Sync Primitives (sync/): 1,880 lines (2.2%)
- Interrupt (interrupt/): 1,649 lines (1.9%)
- Diagnostics (dfx/): 1,019 lines (1.2%)
...
```
Rux/
├── kernel/                 # Kernel source (~86,800 lines)
│   ├── src/
│   │   ├── fs/           # Filesystem (21,570 lines)
│   │   │   ├── ext4/     # ext4 filesystem
│   │   │   ├── jbd2/     # JBD2 journaling layer
│   │   │   ├── devfs/    # devfs device filesystem
│   │   │   └── procfs/   # procfs process filesystem
│   │   ├── arch/         # RISC-V architecture (7,433 lines)
...
- **[Roadmap](docs/progress/roadmap.md)** - Phase planning and current status (Phase 36)
